...
// The loader:
//  - looks up HPyModDef_{modulename} global variable of type HPyModuleDef*
//  - looks up optional HPyCreate_{modulename}
//  - looks up HPyExec_{modulename}

// TODO: #define HPy_MODINIT_CREATE_EXEC(modname, moddef, create_name, exec_name)

#define HPy_MODINIT_EXEC(modname, moddef, exec_name)                  \
    _HPy_HIDDEN HPyContext *_ctx_for_trampolines;                     \
    HPy_EXPORTED_SYMBOL HPyModuleDef *HPyModDef_##modname = &moddef;  \
